...
int main()
{
    ...
    admin* varAdmin = new admin("Budi", "budi@gmail.com");
    member* varMember1 = new member("Andi", "andi@gmail.com", "aktif");
    member* varMember2 = new member("Lia", "lia@gmail.com", "nonaktif");
